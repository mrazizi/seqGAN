...
def train_generator_MLE(gen, gen_opt, real_data_samples, epochs):
    ...
    for epoch in range(epochs):
        ...
        print(' average_train_NLL = %.4f, oracle_sample_NLL = %0' % (total_loss))
...
if __name__ == '__main__':
    ...
    wiki_samples = text_preprocessor.to_tensor()
    ...
    if CUDA:
        ...
        gen = gen.cuda()
        dis = dis.cuda()
        wiki_samples = wiki_samples.cuda()

    # GENERATOR MLE TRAINING
    # print('Starting Generator MLE Training...')
    gen_optimizer = optim.Adam(gen.parameters(), lr=1e-2)
    # train_generator_MLE(gen, gen_optimizer, oracle, wiki_samples, MLE_TRAIN_EPOCHS)
    # train_generator_MLE(gen, gen_optimizer, wiki_samples, MLE_TRAIN_EPOCHS)
    print('Loading Pretrained Generator...')
    # No need to pretrain generator. Out model is already pretrained
    # TODO: load pretrained generator
